...
#region
{
    ...
    #region
    {
        ...
        {
            get { return hideToolBar; } // Get needed for designer to add this entry
            set
            {
                hideToolBar = value;
        ...
        public TableEditor3D()
            ...
            {
                // Add the scroll bar controls to this class so it can be passed down to the dgv, scrollbar and header
                // controllers. Even if the scrollbars or headers aren't used we create it anyway
                ...
                // Subscribe to the user settings event
        ...
        private void Main_Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (Graph3dEnabled && !HideToolBar && dgvGrph3dIntfc.dgv_Selections.Count() > 0)
            {
            ...
            // Copy / paste buttons
            // ----------------------------------------------------
            if (!CopyPasteEnabled || HideToolBar)
            {
                btn_Undo.Enabled = false;
        ...
        {
            Copy.CopyClipboard(dgvCtrl, Copy.SelectMode.SelectedCells, Copy.Headers.Include); // dgv.CopyClipboard_WithAxis();
        }

        private void CopyWithNoAxis_Click(object sender, EventArgs e)
        {
            Copy.CopyClipboard(dgvCtrl, Copy.SelectMode.SelectedCells, Copy.Headers.Exclude);
        }
        ...
        public void btn_LoadSample1_Click(object sender, EventArgs e)
        {
        ...
        public void btn_LoadSample3_Click(object sender = null, EventArgs e = null) // My VE table
        {
            // Load the sample data to the dgv
        ...
        private void btn_RotateGraphDockedLocation_Click(object sender, EventArgs e)
        {
            ...
            // Scroll bar update
            if (UseMyScrollBars)
                dgvCtrl.scrollBarCtrl.ExternalUpdateReq();
        }
        #endregion
    ...
    #region
    {
        ...
        public void Initialise()
        {
            ...
            //
            if (UseMyScrollBars) scrollBarCtrl = new ScrollBarCtrl
            (
                this,
                ScrollBarCntrls.hScrollBar,
                ScrollBarCntrls.vScrollBar,
                ScrollBarCntrls.splitContainer,
                InstanceName
            );
            if (UseMyScrollBars) scrollBarCtrl.Initiate();

            // Headers class
            if (UseMyScrollBars) dgvHeaders = new DgvHeadersCtrl
            (
                this,
                ScrollBarCntrls.RowHeader,
                ScrollBarCntrls.ColHeader,
                ScrollBarCntrls.BlankingPanel,
                ScrollBarCntrls.hScrollBar,
                ScrollBarCntrls.vScrollBar,
                ScrollBarCntrls.splitContainer,
                InstanceName
        ...
        public void Undo_Set(DgvData e)
        {
            ...
            {
                if (undo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Undo returned");
            ...
            {
                if (undo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Undo_Set()");
                ...
                if (undo.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Undo cannot be set");
        ...
        public void Undo_Get()
        {
            ...
            {
                if (undo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Undo Get()");

                // Load the current state to the redo stack
                Redo_Set(myEvents.BuildEventArgs());
        ...
        public void Redo_Set(DgvData e)
        {
            ...
            {
                if (redo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Redo returned");
            ...
            {
                if (redo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Redo_Set()");
                ...
                if (redo.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Redo cannot be set");
        ...
        public void Redo_Get()
        {
            ...
            {
                if (redo.Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Redo Get()");

                // Call the get function. This will make the undo data available via the undoData class properties
                DgvData redoData = redo.Get();

                // Load the current state back to the undo stack
                undo.Set(myEvents.BuildEventArgs());
        ...
        public void Refresh(RefreshMode refreshMode)
        {
            ...
            switch (refreshMode)
            {
                case RefreshMode.All:
                    ...
                    dgvNumFormat.RowHdrFormat = Utils.AutoFormatDouble(ReadRowHeaders());
                    dgvNumFormat.ColHdrFormat = Utils.AutoFormatDouble(ReadColHeaders());
                    dgvNumFormat.CellFormat   = Utils.AutoFormatDouble(dt);
        ...
        {
            if (SizeChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - GetHeaderCellWidths()");
        ...
        {
            if (SizeChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - AutoSetDgvCellWidths()");
        ...
        public void SetCellWidths()
        {
            ...
            string[] rows = dgvHeaders.ReadRowHeaders();
            string[] cols = dgvHeaders.ReadColHeaders();
        ...
        {
            if (SizeChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - AutoSetDgvSize()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteHeaders()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteRowHeaderLabels()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteColHeaderLabels()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteToDataTable1()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteToDataTable2()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - WriteDt() X{col} Y{row}");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadRowHeaders()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadRowHeaderAtIndex()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadColHeaders()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadColumnHeaderAtIndex()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadDataTable1()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadDataTable2()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadDataGridView()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadCellAtAddress()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReadDt() X{col} Y{row}");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ClearDataTable()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ResetDataTable()");
        ...
        {
            if (DgvData_Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - ReDimensionDataTable_v2()");
        ...
        public Point GetTopLeftCellAddress(DataGridViewSelectedCellCollection selectedCells)
        {
            ...
            if (SelectionChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - GetTopLeftCellAddress() X{minColumnIndex} Y{minRowIndex}");
        ...
        #region
        {
            ...
            public string ClassName { get; set; } = "MyEvnt";
            ...
            public MyEvents(DgvCtrl dgvCtrl)
            {
                ...
                tmr_DgvDataChanged_Debounced = new TimerOffDelay
                {
                    ...
                    OnTimingDone = Timer_DgvDataChanged_Debounced_Tick
                };
                ...
                tmr_DgvSizeChanged_Intermittent = new TimerOnDelay
                {
                    ...
                    OnTimingDone = Timer_DgvSizeChanged_Intermittent_Tick
                };
                ...
                tmr_SelectionChanged_Intermittent = new TimerOnDelay
                {
                    ...
                    OnTimingDone = Timer_DgvSelectionChanged_Intermittent_Tick
                };
                ...
                tmr_SelectionChanged_Debounced = new TimerOffDelay
                {
                    ...
                    OnTimingDone = Timer_DgvSelectionChanged_Debounced_Tick
                };
            }
            #endregion
            ...
            public void Pause_All()
            {
                if (!PauseAllEvents && (DebugAll || DebugDataChanged || DebugSizeChanged || DebugSelnChanged || DebugDbncTmr || DebugIntTmr))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Pause_All()");
            ...
            public void Resume_All()
            {
                if (DebugAll || DebugDataChanged || DebugSizeChanged || DebugSelnChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Resume_All()");

                PauseAllEvents = false;

                // Raise events to catch everyone up
                Req_DgvDataChanged_Event(); // bypass equality check
            ...
            public void Pause_DataFromGraph3d()
            {
                if (!PauseDataEventsFromGraph3d && (DebugAll || DebugDataChanged || DebugDbncTmr || DebugIntTmr))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Pause_DataFromGraph3d");
            ...
            public void Resume_DataFromGraph3d()
            {
                if (DebugAll || DebugDataChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Resume_DataFromGraph3d()");
            ...
            public void Pause_SelectionFromGraph3d()
            {
                if (!PauseSelnEventsFromGraph3d && (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Pause_SelectionFromGraph3d()");
            ...
            public void Resume_SelectionFromGraph3d()
            {
                if (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Resume_SelectionFromGraph3d()");
            ...
            {
                if (!PauseSelnEventsFromGraph3d && (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Pause_SelectionToGraph3d()");
            ...
            {
                if (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Resume_SelectionToGraph3d()");
            ...
            {
                if (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Pause_SelectionFromDgvCtrl()");
            ...
            {
                if (DebugAll || DebugSelnChanged || DebugDbncTmr || DebugIntTmr)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Resume_SelectionFromDgvCtrl()");
            ...
            public void Req_DgvDataChanged_Event()
            {
                ...
                if (DebugAll || (DebugDataChanged && !DebugMuteHighSpeed))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Req_DgvDataChanged_Event()");
                ...
                if (DebugAll || (DebugDataChanged && !tmr_DgvDataChanged_Debounced.TimerTiming))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Started timer_DgvDataChanged_Debounced");
            ...
            public DgvData BuildEventArgs()
            {
                ...
                if (DebugAll || (DebugDataChanged && !DebugMuteHighSpeed))
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - DgvDataChanged EventArgs built");
                }

                // Return with the event args
                return e;
            }
            private void Timer_DgvDataChanged_Debounced_Tick(object sender, EventArgs e)
            {
                // Raise the event
                Raise_DgvDataChanged_Debounced_Event();
            }

            private void Raise_DgvDataChanged_Debounced_Event()
            {
                if (DebugAll || DebugDataChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvDataChanged_Debounced_Event");

                // Fire the event to any subscriber
                DgvDataChanged_Debounced?.Invoke(this, BuildEventArgs());
            }
            private void Raise_DgvDataChanged_Immediate_Event()
            {
                if (DebugAll || (DebugDataChanged && !DebugMuteHighSpeed))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvDataChanged_Immediate_Event");

                // Fire the event to any subscriber
                DgvDataChanged_Immediate?.Invoke(this, BuildEventArgs());
            }
            private void Raise_DgvDataChanged_ToHeaders_Event(DgvData e)
            {
                if (DebugAll || (DebugDataChanged && !DebugMuteHighSpeed))
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised Raise_ScrollBarHeaderChanged_Event");
            ...
            public void Req_DgvSizeChanged_Event()
            {
                ...
                if (DebugAll || DebugSizeChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Req_DgvSizeChanged_Event()");
                ...
                if ((DebugAll || DebugSizeChanged) && !tmr_DgvSizeChanged_Intermittent.TimerTiming)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Started tmr_DgvSizeChanged_Intermittent");
            ...
            private void BuildEventArgs_DgvSizeChanged_Event()
            {
                ...
                if (DebugAll || DebugSizeChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - DgvSizeChanged EventArgs built");
            }
            private void Timer_DgvSizeChanged_Intermittent_Tick(object sender, EventArgs e)
            {
                if (DebugAll || DebugSizeChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Timer_DgvSizeChanged_Intermittent_Tick()");

                // Raise the event
                Raise_DgvSizeChanged_Intermittent_Event();
            }

            private void Raise_DgvSizeChanged_Immediate_Event()
            {
                if (DebugAll || DebugSizeChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvSizeChanged_Immediate_Event");
            ...
            {
                if (DebugAll || DebugSizeChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvSizeChanged_Intermittent_Event");
            ...
            public void Req_DgvSelectionChanged_Event()
            {
                ...
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Req_DgvSelectionChanged_Event()");

                // Build the event args
                BuildEventArgs_DgvSelectionChanged_Event();

                if ((DebugAll || DebugSelnChanged) && !tmr_SelectionChanged_Intermittent.TimerTiming)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Started tmr_DgvSelectionChanged_Intermittent");

                if ((DebugAll || DebugSelnChanged) && !tmr_SelectionChanged_Intermittent.TimerTiming)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Started tmr_DgvSelectionChanged_Debounced");
            ...
            private void BuildEventArgs_DgvSelectionChanged_Event()
            {
                ...
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - DgvSelectionChanged EventArgs built");
            }
            private void Timer_DgvSelectionChanged_Intermittent_Tick(object sender, EventArgs e)
            {
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Timer_DgvSelectionChanged_Intermittent_Tick()");

                // Raise the event
                Raise_DgvSelectionChanged_Intermittent_Event();
            }
            private void Timer_DgvSelectionChanged_Debounced_Tick(object sender, EventArgs e)
            {
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Timer_DgvSelectionChanged_Debounced_Tick()");

                // Raise the event
                Raise_DgvSelectionChanged_Debounced_Event();
            }

            private void Raise_DgvSelectionChanged_Intermittent_Event()
            {
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvSelectionChanged_Intermittent_Event");
            ...
            {
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvSelectionChanged_Debounced_Event");
            ...
            {
                if (DebugAll || DebugSelnChanged)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raised DgvSelectionChanged_Event");
        ...
        // DgvCtrl class events
        private void Paste_Completed_NDR(object sender, DgvData e)
        {
            if (UndoEnabled && undo.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Call Undo_Set() from Paste_Completed_NDR()");

            if (EventDebug && UndoEnabled && !undo.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Paste_Completed_NDR()");
            ...
            // Triggers a capture of the dgv image. At this point this class properties (although somewhat scattered)
            // will reflect the paste data change event ags
            Undo_Set(myEvents.BuildEventArgs());
        }
        private void Undo_Completed_NDR(object sender, DgvData e)
        {
            if (undo.Debug || EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Undo_Completed_NDR()");
        ...
        private void IncDec_Incremental_NDR(object sender, EventArgs e)
        {
            if (EventDebug || incDecTask.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - IncDec_Incremental_NDR()");
        ...
        private void IncDec_Completed_NDR(object sender, EventArgs e)
        {
            if (undo.Debug || incDecTask.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Call Undo_Set() from IncDec_Completed_NDR()");

            if (EventDebug && !undo.Debug && !incDecTask.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - IncDec_Completed_NDR()");

            myEvents.Req_DgvDataChanged_Event();
        }

        // Dgv to myEvents intermediate functions
        private void Dgv_MyEvents_CellValueOrDtRowChanged()
        {
            if (UndoEnabled && !undo.InProgress && CopyPasteEnabled && !paste.InProgress && !incDecTask.Mode.Enabled && !Z_RemoteValuesChanging)
            {
                if (EventDebug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_CellValueChanged()");
        ...
        // MyEvent output events subscribed to by this (dgvCtrl) class
        private void MyEvents_Dgv_NDR_Debounced(object sender, DgvData e)
        {
            if (UndoEnabled && undo.Debug && !undo.InProgress)
                Console.WriteLine($"{ClassName} - {InstanceName} - Undo_Set() from MyEvents_Raise_Dgv_NDR_Debounced_Event()");

            if (EventDebug && UndoEnabled && !undo.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_NDR_Debounced()");
        ...
        public void Events_CellDataAndSelectionChanged_Pause()
        {
            if (EventDebug || DataChangedDebug || SelectionChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Events_CellDataAndSelectionChanged_Pause()");
        ...
        {
            if (EventDebug || DataChangedDebug || SelectionChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Events_CellDataAndSelectionChanged_Resume()");
            ...
            //myEvents.Req_DgvSelectionChanged_Event();
            myEvents.Req_DgvDataChanged_ToHeaders_Event(myEvents.BuildEventArgs());
        }

        public void Dgv_SelectionChanged(object sender, EventArgs e)
        {
            if (EventDebug || SelectionChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_SelectionChanged() Current cell X{dgv.CurrentCell.ColumnIndex} Y{dgv.CurrentCell.RowIndex}");
        ...
        private void Dgv_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (SizeChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_SizeChanged()");
        ...
        private void Dt_RowChanged(object sender, DataRowChangeEventArgs e)
        {
            if (EventDebug || DataChangedDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dt_RowChanged()");
        ...
        private void Dgv_MouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (EventDebug || DebugMouse)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_MouseDown() Button {e.Button}");
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                if (dgv.SelectedCells.Count <= 1)
                {
                    ...
                    if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
                    {
                        ...
                        if (DebugMouse)
                            Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_MouseDown() Right click cell selected X{dgv.CurrentCell.ColumnIndex} Y{dgv.CurrentCell.RowIndex}");
                    }
                }
            }
        ...
        {
            if (EventDebug || DebugMouse)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_MouseUp() Button {e.Button}");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_EditingControlShowing()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_EditingControl_KeyPress()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_CellValidating()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_CellEndEdit()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_KeyUp()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_KeyDown()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_Table_CellClick()");
        ...
        {
            if (EventDebug)
                Console.WriteLine($"{ClassName} - {InstanceName} - RowHeader_CellClick()");
        ...
        {
            if (EventDebug)
                Console.WriteLine("${ClassName} - {InstanceName} - ColHeader_CellClick()");
        ...
        {
            if (incDecTask.Debug)
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_IncDecKeyDown()");
        ...
        private void Dgv_IncDecKeyUp()
        {
            if (incDecTask.Debug)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_IncDecKeyUp()");
                Console.WriteLine($"{ClassName} - {InstanceName} - Stop requested");
            }
        ...
        #region
        {
            ...
            public void Start()
            {
                ...
                if (Debug)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Initial increment = {initialIncrement}");
                }
            ...
            private void IncDecTimer_Tick(object sender, EventArgs e)
            {
                Mode.Counter++;
            ...
            private void IncDecCellValue()
            {
                ...
                if (Debug)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Increment  = {increment} ");
                    Console.WriteLine($"{ClassName} - {InstanceName} - Speed mode = {SpeedMode}");
                    Console.WriteLine($"{ClassName} - {InstanceName} - Raise IncDec_Incremental_NDR");
                }
                ...
                if (StopRequest)
                {
                    if (Debug)
                    {
                        Console.WriteLine($"{ClassName} - {InstanceName} - Stop request executing");
                    }
                    Stop();
                }
            }
            ...
            public void Stop()
            {
                ...
                if (Debug)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Stop executed");
                    Console.WriteLine($"{ClassName} - {InstanceName} - Fired IncDec_Completed_NDR()");
                }
    ...
    #region
    {
        ...
        private void MyEvents_Dgv_NDR_Debounced(object sender, DgvData e)
        {
            ...
            {
                if (DebugAll || DebugData)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Returned from Dgv_NDR_Debounced(). Null checks failed");
            ...
            if (!e.HeadersEqual(dgvDataPrev))
            {
                ...
                if (DebugAll || DebugHoverPoint)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_NDR_Debounced() Hover point invalidated");
        ...
        private void Graph3dCtrl_NDR(object sender, List<cPoint3D> e)
        {
            if (DebugAll || DebugPointMoveMode)
                Console.WriteLine($"{ClassName} - {InstanceName} - Graph3dCtrl_NDR");
        ...
        private void Timer_zValuesToDgv_Tick(object sender, EventArgs e)
        {
            if (DebugAll || DebugPointMoveMode)
                Console.WriteLine($"{ClassName} - {InstanceName} - Timer_zValuesToDgv_Tick()");
        ...
        private void Graph3d_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                if (DebugAll || DebugPointMoveMode)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Graph3d_MouseUp()");
                ...
                dgvCtrl.Undo_Set(dgvCtrl.myEvents.BuildEventArgs());
        ...
        private void Dgv_CellMouseEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!MirrorPoints || !dgvCtrl.DgvHasData || !graph3dCtrl.IsDrawn || dgvCtrl.undo.InProgress || dgvCtrl.paste.InProgress || e.RowIndex == -1 || e.ColumnIndex == -1)
            {
                ...
                if (DebugAll || DebugHoverPoint)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_CellMouseEnter() Hover point conditions not valid");
            ...
            if (DebugAll || DebugHoverPoint)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - dgv_HoverPoint" + dgv_HoverPoint.ToString());
            }
        }
        ...
        {
            if (DebugAll)
                Console.WriteLine($"{ClassName} - {InstanceName} - Graph3dToDgv_SelectHoverPoint() start");
            ...
            if (!MirrorPoints || !dgvCtrl.DgvHasData || !graph3dCtrl.IsDrawn || PointMoveMode)
            {
                ...
                if (DebugAll || DebugHoverPoint)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Graph3dToDgv_SelectHoverPoint() Hover point invalidated");
                    Console.WriteLine($"{ClassName} - {InstanceName} - Exit from Graph3dToDgv_SelectHoverPoint {MirrorPoints} {dgvCtrl.DgvHasData} {graph3dCtrl.IsDrawn} {PointMoveMode}");
                }
            ...
            if (hoverPoint.IsValid() && !graph3d_HoverPoint.Equals(hoverPoint))
            {
                ...
                if (DebugAll || DebugHoverPoint)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - graph3d_HoverPoint      " + graph3d_HoverPoint.ToString());
                    Console.WriteLine($"{ClassName} - {InstanceName} - graph3d_HoverPoint_Prev " + graph3d_HoverPoint_Prev.ToString());
                }
            }
            ...
            if (DebugAll)
                Console.WriteLine($"{ClassName} - {InstanceName} - Graph3dToDgv_SelectHoverPoint() end");
        }
        ...
        public void ClearHoverPoints()
        {
            ...
            if (DebugAll || DebugHoverPoint)
                Console.WriteLine($"{ClassName} - {InstanceName} - Hover point invalidated");
        ...
        private void MyEvents_Dgv_SelectionChanged(object sender, DgvCtrl.MyEvents.SelectEventArgs e)
        {
            ...
            if (DebugAll || DebugSelection)
                Console.WriteLine($"{ClassName} - {InstanceName} - MyEvents_Dgv_SelectionChanged");
        ...
        private void Graph3dCtrl_AltClickSelection(object sender, cObject3D e)
        {
            ...
            if (DebugAll || DebugHoverPoint)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Graph3dCtrl_AltClickSelection()");
                Console.WriteLine($"{ClassName} - {InstanceName} - graph3d_HoverPoint " + graph3d_HoverPoint.ToString());
            }
        }
        ...
        {
            // This is a generally universal function that given various data sources can
            // determine the number format optimised to the correct number of decimal places to
            // ensure good readibility of the result
            ...
            switch (type.FullName)
            {
                case "System.Windows.Forms.DataGridView":
                    DataGridView _dgv = obj as DataGridView;
                    rows = _dgv.Rows.Count;
                    columns = _dgv.Columns.Count;
                    ...
                    for (i = 0; i < rows; i++)
                    {
                        for (j = 0; j < columns; j++)
                        {
                            try
                            {
                                values[i, j] = double.Parse(_dgv.Rows[i].Cells[j].ToString());
                            }
                            catch
                            {
                                values[i, j] = 0;
            ...
            try
            {
                for (i = 0; i < rows; i++)
                {
                    for (j = 0; j < columns; j++)
                    {
                        double value = Convert.ToDouble(values[i, j]);
            ...
            {
                throw new Exception($"{ex.Message} at row {i} column {j} at line {ex.StackTrace.Substring(ex.StackTrace.LastIndexOf(":line"))}");
            }

            // Work out what decimal format to use
            ...
            else if (minValue < 0.01) // 0.000001 => 0.009
            {
                ...
                for (i = 0; i < rows; i++)
                {
                    for (j = 0; j < columns; j++)
                    {
                        if (Convert.ToDouble(values[i, j]) != 0) // this stops 20 max leading 0's being reported
                        {
                            string stringValue = Convert.ToDouble(values[i, j]).ToString("F20");
        ...
        #region
        {
            ...
            public override string ToString()
            {
                return String.Format("(X={0}, Y={1},  Z={2}, UsrSlctn={3}, HvrSlctn={4})",
                    X_Index.ToString(FormatDouble(X_Index)), Y_Index.ToString(FormatDouble(Y_AxisTag)), Z.ToString(FormatDouble(Z)), UserSelected, HoverSelected);
            }
    ...
    #region
    {
        ...
        public void SetPlotData(double[] x, double[] y, double[,] z) // Master plot data, call during paste ops, new dgv etc.
        {
            ...
            {
                if (DebugData)
                    Console.WriteLine($"{ClassName} - {InstanceName} - SetPlotData() returned, graph values invalid");
            ...
            if (DebugData)
                Console.WriteLine($"{ClassName} - {InstanceName} - SetPlotData(x, y, z)");
        ...
        public void DrawPlot()
        {
            ...
            {
                if (DebugData)
                    Console.WriteLine($"{ClassName} - {InstanceName} - DrawPlot() returned, graph values invalid");
            ...
            if (DebugData)
                Console.WriteLine($"{ClassName} - {InstanceName} - DrawPlot()");
        ...
        {
            if (DebugData)
                Console.WriteLine($"{ClassName} - {InstanceName} - UpdatePlot(x, y, z)");
        ...
        private eInvalidate OnSelectEvent(eSelEvent e_Event, Keys e_Modifiers, int s32_DeltaX, int s32_DeltaY, cObject3D i_Object)
        {
            ...
            {
                //Console.WriteLine($"{ClassName} - {InstanceName} - Selection call back active");
            ...
            if (e_Event == eSelEvent.MouseDown && !b_CTRL && i_Object != null)
            {
                ...
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Point select AltSelection event fired");
                }
            ...
            else if (e_Event == eSelEvent.MouseDrag && b_CTRL)
            {
                ...
                {
                    //Console.WriteLine($"{ClassName} - {InstanceName} - Point move code section active");
                ...
                if (DebugPointMoveMode)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - Point move Graph3d_NDR event fired");
                }
    ...
    #region
    {
        ...
        //------------------------- Constructor ---------------------------------------------------------------------------------------
        #region
        public ScrollBarCtrl(DgvCtrl dgvCtrl, HScrollBar hScroll, VScrollBar vScroll, SplitContainer splitContainer, string instanceName)
        {
            ...
            // Class members
            this.dgvCtrl = dgvCtrl;
            this.parent = dgvCtrl.dgv.Parent;
        ...
        public void Initiate()
        {
            ...
            if (DebugPosition)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Initiate()");
            }
        ...
        {
            // This function is called from the table editor class when the split container resize event fires. This
            // event is debounced so it should only occur once at the end of the resize. A resize end event is not
            // available

            if (DebugPosition)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - ExternalUpdateReq()");
                //Console.WriteLine($"{ClassName} - {InstanceName} - pRect() {pRect()}");
                //Console.WriteLine($"{ClassName} - {InstanceName} - cRect {cRect}");
            }
            ...
            if (pRect().Height >= cRect.Height || pRect().Width >= cRect.Width)
            {
                ...
                if (DebugPosition)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - 1");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - pRect() {pRect()}");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - cRect {cRect}");
                }
                if (!cRect.Equals(cRectLast))
                {
                    //Console.WriteLine($"{ClassName} - {InstanceName} - Child shifted");
                }
            ...
            if (cLoc.Y > 0 || cLoc.X > 0)
            {
                ...
                if (DebugPosition)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - 2");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - pRect() {pRect()}");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - cRect {cRect}");
                }
                if (!cRect.Equals(cRectLast))
        ...
        CheckWhiteSpace:
            ...
            if (cLoc.Y != 0)
            {
                ...
                if (DebugPosition)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - 3");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - pRect() {pRect()}");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - cRect {cRect}");
                }
                if (!cRect.Equals(cRectLast))
            ...
            if (cLoc.X != 0)
            {
                ...
                if (DebugPosition)
                {
                    Console.WriteLine($"{ClassName} - {InstanceName} - 4");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - pRect() {pRect()}");
                    //Console.WriteLine($"{ClassName} - {InstanceName} - cRect {cRect}");
                }
                if (!cRect.Equals(cRectLast))
        ...
        // Timer tick event
        private void DgvMove_TimerOff_Tick(object sender, EventArgs e)
        {
            // Debug message
            //if (Debug)
            //{
            //    Console.WriteLine($"{ClassName} - {InstanceName} - {scrlBrDgvMvTmr.DebugName} TimerOff_Tick()");
            //}
        ...
        private void Dgv_NDR_Debounced(object sender, DgvData e)
        {
            ...
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - MyEvents_NDR_Debounced()");
            }
        ...
        {
            // If re-enabling, event load has been commented out

            //if (Debug)
            //{
            //    Console.WriteLine($"{ClassName} - {InstanceName} - Parent_SizeChanged()");
            //}
        }
        ...
        private void Child_Move(object sender, EventArgs e)
        {
            ...
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_Move()");
            }
        }
        ...
        private void Scroll_MouseEnter(object sender, EventArgs e)
        {
            ...
            if (DebugScrollBars)
            {
                //Console.WriteLine($"{ClassName} - {InstanceName} - Scroll_MouseEnter()");
            }
        ...
        private void Scroll_MouseLeave(object sender, EventArgs e)
        {
            ...
            if (DebugScrollBars)
            {
                //Console.WriteLine($"{ClassName} - {InstanceName} - Scroll_MouseLeave()");
            }
        ...
        private void hScroll_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (DebugScrollBars)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - hScroll_Scroll()");
            }
        ...
        private void vScroll_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (DebugScrollBars)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - vScroll_Scroll()");
            }
        ...
        private void Dgv_MouseWheel(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (DebugMouseWheel)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Dgv_MouseWheel()");
            }
        ...
        private void Parent_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (DebugMouseWheel)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Parent_Scroll()");
            }
        ...
        private void Parent_MouseWheel(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (DebugMouseWheel)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - Parent_MouseWheel()");
            }
        ...
        private void UpdateScrollBarVisibilityAndValues()
        {
            ...
            if (DebugScrollBars)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - UpdateScrollBars()");
            }
        ...
        private void SetScrollBarVisibility()
        {
            ...
            if (DebugScrollBars)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - hScroll.Visible {hScroll.Visible}");
                Console.WriteLine($"{ClassName} - {InstanceName} - vScroll.Visible {vScroll.Visible}");
            }
        }
        ...
        private void AssignScrollValues()
        {
            ...
            if (DebugScrollBars)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - hScroll.Value = {hScroll.Value}");
                Console.WriteLine($"{ClassName} - {InstanceName} - vScroll.Value = {vScroll.Value}");
            }
        }
        ...
        private void LoadEvents()
        {
            ...
            //child.Move          += Child_Move;
            //child.MouseWheel += Dgv_MouseWheel;
    ...
    #region
    {
        ...
        #region Constructor
        public DgvHeadersCtrl(DgvCtrl dgvCtrl, DataGridView rowHeader, DataGridView colHeader, Panel blankingPanel, HScrollBar hScroll, VScrollBar vScroll, SplitContainer splitContainer, string instanceName)
        {
            this.dgvCtrl = dgvCtrl;
            this.dgvCtrl.dgv = dgvCtrl.dgv;
            this.dgv_RowHeader = rowHeader;
            this.dgv_ColHeader = colHeader;
            this.panel_BlankingPlate = blankingPanel;
            this.hScroll = hScroll;
            this.vScroll = vScroll;
            // Debug name
            InstanceName = instanceName;
            ...
            rowHeader.CellClick += RowHeader_CellClick;
            colHeader.CellClick += ColHeader_CellClick;
            splitContainer.Resize += SplitContainer_Resize;
        }
        #endregion
        ...
        private void MyEvents_DgvDataChanged_ToHeaders_Event(object sender, DgvData e)
        {
            ...
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - MyEvents_ScrollBarDataChanged_Event()");
            }
        ...
        private void MyEvents_SizeChanged_Intermittent(object sender, DgvCtrl.MyEvents.SizeEventArgs e)
        {
            ...
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - MyEvents_SizeChanged_Intermittent()");
            }
        ...
        private void HideHeaders()
        {
            dgv_RowHeader.Hide();
            dgv_ColHeader.Hide();
            panel_BlankingPlate.Hide();

            // Debug message
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - HideHeaders()");
            }
        }
        ...
        private void UnhideHeaders()
        {
            dgv_RowHeader.Show();
            dgv_ColHeader.Show();
            panel_BlankingPlate.Show();

            dgv_RowHeader.BringToFront();
            dgv_ColHeader.BringToFront();
            hScroll.BringToFront();
            vScroll.BringToFront();
            panel_BlankingPlate.BringToFront();

            // Debug message
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - UnhideHeaders()");
            }
        }
        ...
        private void LoadHeaders(DgvData e)
        {
            ...
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - LoadNewHeaders(PasteEventArgs)");
            }
            ...
            {
                if (DebugHeaders)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Returned from LoadHeaders(). Null checks failed");
            ...
            PanelStyleOverrides(panel_BlankingPlate);
        ...
        private void LoadHeaders(DgvCtrl.MyEvents.SizeEventArgs e)
        {
            ...
            if (DebugHeaders)
            {
                Console.WriteLine($"{ClassName} - {InstanceName} - LoadNewHeaders(MyEvent SizeEventArgs)");
            }
    ...
    #region
    {
        ...
        public static string AutoFormatDouble(DataTable dt)
        {
            if (dt == null)
                return String.Empty;
    ...
    #region
    {
        ...
        public void Set(DgvData dgvData)
        {
            ...
            {
                if (Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - Duplicate entry rejected");
    ...
    #region
    {
        ...
        public static void CopyClipboard(DgvCtrl dgvCtrl, SelectMode selectMode, Headers headerMode)
        {
    ...
    #region
    {
        ...
        public void ParseClipboardToDgv(DgvCtrl dgvCtrl, Mode copyPasteMode, DataSource dataSource = DataSource.ClipBoard, string fileName = null)
        {
            ...
            // Locals
            int i, j;
            DataTable dt = GetBoundDataTable(dgvCtrl.dgv);
            bool error = false;
            #endregion
            ...
            try
            {
                ...
                if (Debug)
                    Console.WriteLine($"{ClassName} - {InstanceName} - ParseClipboardToDgv.InProgress {InProgress}");
                ...
                switch (copyPasteMode)
                {
                    ...
                    case Mode.PasteTableWithNoAxis:
                        ...
                        if (Debug)
                            Console.WriteLine($"{ClassName} - {InstanceName} - {Enum.GetName(typeof(Mode), copyPasteMode)}");
        ...
        private int GetColCountFromRawInputText(string input)
        {
            ...
            if (!IsNumber(columns[0]) || columns[0] == String.Empty)
            {
            ...
            if (columns[columns.Length - 1] == string.Empty || !IsNumber(columns[columns.Length - 1]))
            {
        ...
        private DataTable GetBoundDataTable(DataGridView dataGridView)
        {
...
#region
{
    ...
    #region
    {
        ...
        // Define a delegate for the TimingDone event
        public delegate void TimingDoneEventHandler(object sender, EventArgs e);

        // Add a property of the delegate type
        public TimingDoneEventHandler OnTimingDone { get; set; }
        #endregion
        ...
        public TimerOnDelay()
        {
            ...
            microTimer.MicroTimerElapsed += new MicroLibrary.MicroTimer.MicroTimerElapsedEventHandler(Tick);
        ...
        private void Tick(object sender, MicroLibrary.MicroTimerEventArgs timerEventArgs)
        {
        ...
        public void TriggerTimingDoneEvent()
        {
            RaiseOnTimingDoneEvent(EventArgs.Empty);
        }

        protected virtual void RaiseOnTimingDoneEvent(EventArgs e)
        {
            uiControl.BeginInvoke((MethodInvoker)delegate
            {
                OnTimingDone?.Invoke(this, EventArgs.Empty);
            });
        }
    ...
    #region
    {
        ...
        private readonly MicroLibrary.MicroTimer taskTimer;
        #endregion
        ...
        {
            // New MicroTimer and add event handler
            taskTimer = new MicroLibrary.MicroTimer();
            taskTimer.MicroTimerElapsed += new MicroLibrary.MicroTimer.MicroTimerElapsedEventHandler(Tick);
