...
public partial class App : Form
{
    ...
    {
        // .Net requires cycling through all tabs for the dgv colour format to apply
        tabPage4.Show();
        tabPage3.Show();
        tabPage2.Show();
        tabPage1.Show();
    ...
    private void Debug(TableEditor3D editor)
    {
        ...
        // Calling this overrides all the settings above and sets every property in the debug class to true. A
        // large number of console messages are generated!
        if (debugAll)
