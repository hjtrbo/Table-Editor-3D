...
namespace TableEditor
{
    public partial class AverageTool : Form
    {
        ...
        {
            Copy.CopyClipboard(dgv_RunAvg, Copy.SelectMode.SelectAll, Copy.Headers.Exclude);
        }
        ...
        private void copyWithAxisToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dgv_RunAvg.dgv.Focused)
                Copy.CopyClipboard(dgv_RunAvg, Copy.SelectMode.SelectedCells, Copy.Headers.Include);

            if (dgv_RunAvgCnt.dgv.Focused)
                Copy.CopyClipboard(dgv_RunAvgCnt, Copy.SelectMode.SelectedCells, Copy.Headers.Include);
        }

        private void copyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dgv_RunAvg.dgv.Focused)
                Copy.CopyClipboard(dgv_RunAvg, Copy.SelectMode.SelectedCells, Copy.Headers.Exclude);

            if (dgv_RunAvgCnt.dgv.Focused)
                Copy.CopyClipboard(dgv_RunAvgCnt, Copy.SelectMode.SelectedCells, Copy.Headers.Exclude);
        }
